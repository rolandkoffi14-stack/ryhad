      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Gestion des composants et consommables en atelier.
          </p>
        </div>
      </div>
          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-brand-slate text-gray-500 font-bold uppercase tracking-wider text-[10px] border-b border-gray-100">
              <tr>
                ...
                <th className="px-6 py-3.5 text-center">En Stock</th>
                <th className="px-6 py-3.5 text-center">Seuil</th>
                <th className="px-6 py-3.5">État</th>
              </tr>
            </thead>

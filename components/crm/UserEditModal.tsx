              ...
              <div className="p-3.5 bg-brand-slate/80 rounded-2xl border border-gray-200 space-y-3 animate-in fade-in duration-150">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-[11px] text-brand-blue hover:underline font-bold cursor-pointer"
                  >
                ...
                <div className="grid grid-cols-2 gap-1.5 text-[10px]">
                  <span className={passwordCriteria.length ? "text-brand-blue font-bold" : "text-gray-400"}>
                    • 10 caractères minimum
                  </span>
                  <span className={passwordCriteria.hasUpper ? "text-brand-blue font-bold" : "text-gray-400"}>
                    • 1 Majuscule (A-Z)
                  </span>
                  <span className={passwordCriteria.hasLower ? "text-brand-blue font-bold" : "text-gray-400"}>
                    • 1 Minuscule (a-z)
                  </span>
                  <span className={passwordCriteria.hasNumber ? "text-brand-blue font-bold" : "text-gray-400"}>
                    • 1 Chiffre (0-9)
                  </span>
                  <span className={passwordCriteria.hasSpecial ? "text-brand-blue font-bold col-span-2" : "text-gray-400 col-span-2"}>
                    • 1 Caractère spécial (!@#$%^&*...)
                  </span>
                </div>
              </div>
